...
public class AzkarAfterPray extends AsyncTask<Void, Void, List<RemembranceDetailsModel>> {

    private static final String TAG = AzkarAfterPray.class.getSimpleName();
    private static final String JSON_URL = "https://ahegazy.github.io/muslimKit/json/PostPrayer_azkar.json";
    private ProgressBar progressBar;

    private RemembranceDetailsActivity fragment;

    public AzkarAfterPray(RemembranceDetailsActivity fragment, ProgressBar progressBar) {
    ...
    protected void onPostExecute(List<RemembranceDetailsModel> quranChapters) {
        ...
        AppPreferences.getInstance(fragment).setStringPreference("PostPrayer_azkar",json);
