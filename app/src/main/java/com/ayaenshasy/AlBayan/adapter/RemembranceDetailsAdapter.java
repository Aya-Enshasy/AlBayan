...
import com.ayaenshasy.AlBayan.databinding.RemembranceDetailsItemBinding;
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.constraintlayout.setOnClickListener(v -> {
            if (count.get() <=1) {
                ...
                holder.binding.constraintlayout.setBackground(context.getDrawable(R.drawable.remembrance_red));
//                holder.binding.constraintlayout.setBackground(context.getColor(com.google.android.material.R.color.design_default_color_error));
            } else {
                count.getAndDecrement();
                holder.binding.constraintlayout.setBackground(context.getDrawable(R.drawable.remembrance));
